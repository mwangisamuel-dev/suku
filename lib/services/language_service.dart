...
class LanguageService {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'English': {
      ...
      'mpesaPinOption': 'M-Pesa PIN',
      'cardPaymentOption': 'Card payment',
      'enterMpesaPin': 'Enter your M-Pesa PIN',
      'enterCardDetails': 'Enter card number',
      'payButton': 'Pay',
    ...
    'Kiswahili': {
      ...
      'mpesaPinOption': 'PIN ya M-Pesa',
      'cardPaymentOption': 'Malipo ya kadi',
      'enterMpesaPin': 'Weka PIN yako ya M-Pesa',
      'enterCardDetails': 'Weka namba ya kadi',
      'payButton': 'Lipa',
