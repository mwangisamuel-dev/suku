...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
  ...
  Future<void> _savePlan(String plan) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Text('Subscription updated to $plan', style: GoogleFonts.plusJakartaSans(color: Colors.white)),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Manage your subscription and choose the best plan for your business.',
                  style: GoogleFonts.plusJakartaSans(fontSize: 14, color: SukuColors.textSecondary, height: 1.5)),
              const SizedBox(height: 24),
              _PlanTile(
                title: 'Free',
                subtitle: 'Basic bookkeeping and business tracking',
              ...
              _PlanTile(
                title: 'Pro',
                subtitle: 'Advanced reports, PDF exports, and premium support',
              ...
              _PlanTile(
                title: 'Business',
                subtitle: 'Full business management tools for growing enterprises',
                active: _selectedPlan == 'Business',
                onTap: () => _savePlan('Business'),
              ),
              const SizedBox(height: 24),
              Text('Current plan: $_selectedPlan',
                  style: GoogleFonts.plusJakartaSans(
