...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  final summary = SampleData.monthlySummary;
  ...
  Future<void> _loadBusinessInfo() async {
    ...
    setState(() {
      _businessName =
          prefs.getString('business_name') ?? 'Biashara yako';
      _businessLocation = prefs.getString('location') ?? '';
      _businessType = prefs.getString('business_type') ?? '';
    });
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                color: SukuColors.orange.withOpacity(0.45),
                blurRadius: 20,
              ...
              children: List.generate(items.length, (i) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: active
                          ? SukuColors.green.withOpacity(0.1)
                          : Colors.transparent,
              ...
              Row(
                children: [
                  _MiniStat(
                      label: 'Money In',
                      value: visible
                          ? 'Ksh ${NumberFormat('#,##0').format(summary.totalIncome)}'
                          : '••••',
                      color: SukuColors.greenLight),
                  Container(
                      margin:
                  ...
                  _MiniStat(
                      label: 'Money Out',
                      value: visible
                          ? 'Ksh ${NumberFormat('#,##0').format(summary.totalExpenses)}'
                          : '••••',
...
class _WeeklyChartState extends State<_WeeklyChart> {
  ...
  final income = SampleData.weeklyIncome;
  final expenses = SampleData.weeklyExpenses;

  @override
  Widget build(BuildContext context) {
    final data = _showIncome ? income : expenses;
      ...
      child: AnimatedContainer(
        ...
        child: Text(label,
            style: GoogleFonts.plusJakartaSans(
                fontSize: 13,
                fontWeight: FontWeight.w700,
                color: active ? color : SukuColors.textHint)),
      ),
    );
  }
}
              ...
              Row(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                          'Ksh ${NumberFormat('#,##0').format(e.value)}',
                          style: GoogleFonts.plusJakartaSans(
                              fontSize: 13,
                              fontWeight: FontWeight.w700,
                              color: SukuColors.textPrimary)),
...
class _TransactionsTabState extends State<_TransactionsTab> {
  ...
  List<Transaction> get filtered => _filter == null
      ? widget.transactions
      : widget.transactions
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color:
                  active ? c.withOpacity(0.3) : SukuColors.border),
        ),
        child: Text(label,
            style: GoogleFonts.plusJakartaSans(
                fontSize: 13,
                fontWeight: FontWeight.w600,
                color: active ? c : SukuColors.textSecondary)),
      ),
    );
  }
}
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      _summaryRow(context, 'Jumla ya Mapato',
                          summary.totalIncome, SukuColors.green),
                      const Divider(
                          height: 20, color: SukuColors.border),
                      _summaryRow(context, 'Jumla ya Matumizi',
                          summary.totalExpenses, SukuColors.error),
                      const Divider(
                          height: 20, color: SukuColors.border),
                      _summaryRow(
                          context,
...
class _SettingsTabState extends State<_SettingsTab> {
  ...
  Future<void> _load() async {
    ...
    setState(() {
      ...
      _location =
          prefs.getString('location') ?? 'Nairobi, Kenya';
      _businessType =
          prefs.getString('business_type') ?? 'shop';
    });
  }
    ...
    return Container(
      ...
      child: ListTile(
        ...
        trailing: Icon(Icons.chevron_right_rounded,
            color: SukuColors.textHint, size: 20),
        shape: RoundedRectangleBorder(
