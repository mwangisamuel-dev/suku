...
class _MpesaScreenState extends State<MpesaScreen> {
  ...
  void _parseSms(String sms) {
    ...
    // Type: received = income, sent/paid = expense
    ...
    } else if (lower.contains('safaricom') || lower.contains('airtel') || lower.contains('faiba')) {
      cat = ExpenseCategory.utilities;
    } else if (lower.contains('naivas') || lower.contains('quickmart') || lower.contains('carrefour') ||
        lower.contains('market') || lower.contains('wholesale')) {
      cat = ExpenseCategory.stock;
    } else if (lower.contains('rent') || lower.contains('kodi') || lower.contains('estate')) {
    ...
    } else if (lower.contains('matatu') || lower.contains('uber') || lower.contains('bolt') ||
        lower.contains('petrol') || lower.contains('parking')) {
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Paste any M-Pesa confirmation SMS below. Suku will extract the transaction automatically.',
                      style: GoogleFonts.plusJakartaSans(
                          fontSize: 13,
            ...
            if (_parsed != null) ...[
              ...
              if (_parsed!.containsKey('error'))
                ...
                SectionHeader(title: 'Extracted Transaction'),
                const SizedBox(height: 12),
                Container(
                  ...
                  child: Column(
                    children: [
                      _row('Type',
                          (_parsed!['type'] == TransactionType.income)
                              ? 'Money In ↑'
                              : 'Money Out ↓',
                          _parsed!['type'] == TransactionType.income
                              ? SukuColors.green
                      ...
                      _row('Amount',
                          ...
                          bold: true),
                      const Divider(height: 20, color: SukuColors.border),
                      _row('Vendor / From', _parsed!['vendor'] as String,
                          SukuColors.textPrimary),
                      if (_parsed!['category'] != null) ...[
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            CategoryBadge(
                                category:
                                    _parsed!['category'] as ExpenseCategory),
                          ],
                        ),
                      ],
                    ],
                  ...
                  child: ElevatedButton.icon(
                    ...
                    icon: Icon(
                        _saved
                            ...
                            : Icons.save_rounded,
                        size: 20),
                    label: Text(_saved ? 'Saved!' : 'Hifadhi — Save Transaction'),
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          _saved ? SukuColors.greenDark : SukuColors.green,
                      foregroundColor: Colors.white,
                      elevation: 0,
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(14)),
